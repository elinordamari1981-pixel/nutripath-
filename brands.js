...
const BRANDS = {
  ...
  'תירס פופקורן (גרעינים)': { brand: 'שופרסל / תפזורת', cat: 'pantry' },
};

const PRODUCE_KEYWORDS = ['אבוקדו', 'אפונה', 'בטטה', 'בננ', 'בצל', 'ברוקולי', 'גזר', 'זית', 'חסה', 'כרוב', 'מלפפון', 'נקטרינה', 'סלרי', 'עגבני', 'ענבים', 'פלפל', 'קישוא', 'קיווי', 'קייל', 'שעועית ירוקה', 'תותים', 'תפוז', 'תפוח', 'אספרגוס', 'תרד', 'פטריות', 'פירות יער', 'רימון', 'אננס', 'אפרסק', 'ירקות'];
